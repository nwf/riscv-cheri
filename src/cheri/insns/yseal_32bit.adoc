...
For example, it may be possible to seal a capability
with a given <<sec_cap_type>> value only if that capability
grants, or does not grant, a particular permission.
=====
